...
namespace KedSys35
{
    public partial class ReportSentDate : System.Web.UI.Page
    {
        dal dl = new dal();
        string EmployeeID;
        ...
        void BindGrid()
        {
            ...
            dsReport = dl.UP_Report_ManagerDateWise(DATEFROM, DATETO, MGRID, LEADERID, DEPARTMENT, STATUS, LOGINEMPID);
