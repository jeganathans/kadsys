...
namespace KedSys35
{
    public partial class TimeSheetDetailed : System.Web.UI.Page
    {
        dal dl = new dal();
        string EmployeeID;
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                ViewState["SortExpr"] = "TimeSheetDate ASC";
                BindCombo();
            }
        }
        ...
        void BindGrid()
        {
            string DATEFROM, DATETO, EMPID, MGRID, DIRID, DEPARTMENT, LOGINEMPID;
            ...
            dsReport = dl.UP_Report_TimesheetDetailed(DATEFROM, DATETO, EMPID, MGRID, DIRID, DEPARTMENT, LOGINEMPID);
