<%@ Page Title="Kadence | Invoice" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ReportInvoiceGroup.aspx.cs" Inherits="KedSys35.ReportInvoiceGroup" EnableEventValidation="false"%>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="control-label">
                                            Group</label>
                                        <div class="input-groupd">
                                            <asp:DropDownList ID="ddGroup" class="form-control select2me" runat="server">
                                            </asp:DropDownList>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="portlet-title">
                    ...
                    <asp:GridView ID="GridView1" runat="server" Width="100%" AutoGenerateColumns="False"
                        ...
                        <Columns>
                            <asp:TemplateField>
                                <HeaderTemplate>
                                    <asp:Label ID="lblLeader" runat="server" Text="Leader Name"></asp:Label>
                                </HeaderTemplate>
                                <ItemTemplate>
