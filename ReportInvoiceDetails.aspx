<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ReportInvoiceDetails.aspx.cs" 
    Inherits="KedSys35.ReportInvoiceDetails" Title="Kadence | Invoice" EnableEventValidation="false"%>
                    ...
                    <asp:GridView ID="GridView1" runat="server" Width="100%" AutoGenerateColumns="False"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField>
                                ...
                                <ItemTemplate>
                                    <asp:Label ID="PaymentTerms" CssClass="" runat="server" Text='<%#Eval("PaymentTerms")%>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField>
                                <HeaderTemplate>
